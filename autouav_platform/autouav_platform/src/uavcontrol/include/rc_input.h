...
//     bool force_command_control{false}; // 新增：强制Command Control标志
...
//     // 修改：添加force参数，允许解除强制Command Control状态
//     void forceEnterCommandControl(bool force = true)
//     {
//         force_command_control = force;
//         enter_command_control = force;
//         in_command_control = force;
//         in_rc_pos_control = !force;
//     }
     
//     // 辅助函数：判断当前模式
//     bool isPosMode() const { return in_rc_pos_control; }
//     bool isCommandMode() const { return in_command_control; }
//     bool isInitMode() const { return in_init; }
...
//     static constexpr double MODE_INIT_THRESHOLD = 0.3;    // 初始化模式阈值
//     static constexpr double MODE_POS_THRESHOLD = 0.7;     // POSITION模式阈值
//     static constexpr double MODE_DEAD_ZONE = 0.05;        // 死区范围
...
//     force_command_control = false; // 初始化强制标志
// }
...
//     cout << GREEN << "force_command : " << force_command_control << TAIL << endl; // 显示强制标志
// }
...
//     // 修改：通道6状态切换逻辑
//     // 如果没有被强制进入Command Control模式，则允许通过通道6切换状态
//     if (!force_command_control)
//     {
...
//     else
//     {
//         // 如果处于强制Command Control模式，检查是否允许退出
//         // 例如：当通道6从高位置切换到中间位置时退出强制模式
//         if (last_channel_6 >= channel_6_threshold_value_2 && 
//             channel_6 > channel_6_threshold_value_1 && 
//             channel_6 < channel_6_threshold_value_2)
//         {
//             forceEnterCommandControl(false); // 解除强制状态
//         }
//     }
...
//         in_command_control = false;
//     }
//     else if (enter_rc_pos_control)
//     {
//         in_init = false;
//         in_rc_pos_control = true;
//         in_command_control = false;
//     }
//     else if (enter_command_control)
//     {
//         in_init = false;
//         in_rc_pos_control = false;
