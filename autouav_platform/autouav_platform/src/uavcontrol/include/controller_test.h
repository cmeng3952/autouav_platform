...
class Controller_Test
{
    public:
        ...
        void setCircleParams(float radius, float linear_velocity, float dir) {
           ...
           // 8字轨迹参数设置
       void setEightParams(float radial, float omega) {
	    radial = radial;
	    eight_omega_ = omega;
        ...
        uavcontrol_msgs::UAVCommand Circle_trajectory_generation(float time_from_start);

        uavcontrol_msgs::UAVCommand Eight_trajectory_generation(float time_from_start);

        uavcontrol_msgs::UAVCommand Step_trajectory_generation(float time_from_start);

        uavcontrol_msgs::UAVCommand Line_trajectory_generation(float time_from_start);
...
uavcontrol_msgs::UAVCommand Controller_Test::Circle_trajectory_generation(float time_from_start)
{
    uavcontrol_msgs::UAVCommand Circle_trajectory;
    float omega;
    if( circle_radius != 0)
    {
...
uavcontrol_msgs::UAVCommand Controller_Test::Line_trajectory_generation(float time_from_start)
{
    uavcontrol_msgs::UAVCommand Line_trajectory;
    float omega;
    if( circle_radius != 0)
    {
        omega = direction * fabs(linear_vel / circle_radius);
...
uavcontrol_msgs::UAVCommand Controller_Test::Eight_trajectory_generation(float time_from_start)
{
    ...
    uavcontrol_msgs::UAVCommand Eight_trajectory;
...
uavcontrol_msgs::UAVCommand Controller_Test::Step_trajectory_generation(float time_from_start)
{
    uavcontrol_msgs::UAVCommand Step_trajectory;
