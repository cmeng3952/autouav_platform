...
#include "uavcontrol_msgs/GimbalState.h"
#include "uavcontrol_msgs/Control.h"
#include "uavcontrol_msgs/GimbalControl.h"
// 自定义消息
...
public:
    ...
    void stateCb(const uavcontrol_msgs::UAVState::ConstPtr &msg);

    //【回调】uav反馈信息
    void textInfoCb(const uavcontrol_msgs::TextInfo::ConstPtr &msg);

    void controlStateCb(const uavcontrol_msgs::UAVControlState::ConstPtr &msg);

    void offsetPoseCb(const uavcontrol_msgs::OffsetPose::ConstPtr &msg);

    struct UAVState getUAVState();

    void uavCmdPub(struct UAVCommand uav_cmd);

    void uavCmdCb(const uavcontrol_msgs::UAVCommand::ConstPtr &msg);
    ...
    void gimbalStateCb(const uavcontrol_msgs::GimbalState::ConstPtr &msg);

    void customDataSegmentCb(const uavcontrol_msgs::CustomDataSegment::ConstPtr &msg);
...
private:
    ...
    uavcontrol_msgs::OffsetPose offset_pose_;
