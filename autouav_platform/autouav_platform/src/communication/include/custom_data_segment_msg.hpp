...
#include "UAVcontrol_msgs/CustomDataSegment.h"
#include "string.h"
...
{
public:
    CustomDataSegmentMSG(UAVcontrol_msgs::CustomDataSegment msg)
    {
    ...
    bool addValue(std::string name, int value)
    {
        if(indexof(name) == -1)
        {
            UAVcontrol_msgs::BasicDataTypeAndValue data = initBasicDataTypeAndValue(name);
    ...
    bool addValue(std::string name, float value)
    {
        ...
        {
            UAVcontrol_msgs::BasicDataTypeAndValue data = initBasicDataTypeAndValue(name);
            data.type = UAVcontrol_msgs::BasicDataTypeAndValue::FLOAT;0o
    ...
    void setValue(std::string name, int value)
    {
        ...
        if (index != -1)
        {
            custom_data_segment.datas[index].type = UAVcontrol_msgs::BasicDataTypeAndValue::INTEGER;
    ...
    void setValue(std::string name, bool value)
    {
        ...
        if (index != -1)
        {
            custom_data_segment.datas[index].type = UAVcontrol_msgs::BasicDataTypeAndValue::BOOLEAN;
    ...
    void setValue(std::string name, float value)
    {
        ...
        if (index != -1)
        {
            custom_data_segment.datas[index].type = UAVcontrol_msgs::BasicDataTypeAndValue::FLOAT;
    ...
    void setValue(std::string name, double value)
    {
        ...
        if (index != -1)
        {
            custom_data_segment.datas[index].type = UAVcontrol_msgs::BasicDataTypeAndValue::DOUBLE;
    ...
    void setValue(std::string name, std::string value)
    {
        ...
        if (index != -1)
        {
            custom_data_segment.datas[index].type = UAVcontrol_msgs::BasicDataTypeAndValue::STRING;
    ...
    bool getValue(std::string name, int &value)
    {
        ...
        if (index != -1)
        {
            if (custom_data_segment.datas[index].type == UAVcontrol_msgs::BasicDataTypeAndValue::INTEGER)
            {
    ...
    bool getValue(std::string name, float &value)
    {
        ...
        if (index != -1)
        {
            if (custom_data_segment.datas[index].type == UAVcontrol_msgs::BasicDataTypeAndValue::FLOAT)
            {
    ...
    bool getValue(std::string name, double &value)
    {
        ...
        if (index != -1)
        {
            if (custom_data_segment.datas[index].type == UAVcontrol_msgs::BasicDataTypeAndValue::DOUBLE)
            {
    ...
    bool getValue(std::string name, bool &value)
    {
        ...
        if (index != -1)
        {
            if (custom_data_segment.datas[index].type == UAVcontrol_msgs::BasicDataTypeAndValue::BOOLEAN)
            {
    ...
    bool getValue(std::string name, std::string &value)
    {
        ...
        if (index != -1)
        {
            if (custom_data_segment.datas[index].type == UAVcontrol_msgs::BasicDataTypeAndValue::STRING)
            {
    ...
    // 返回自定义数据
    UAVcontrol_msgs::CustomDataSegment getCustomDataSegment()
    {
        return custom_data_segment;
    }

    // 初始化基本变量
    UAVcontrol_msgs::BasicDataTypeAndValue initBasicDataTypeAndValue(string name)
    {
...
private:
    UAVcontrol_msgs::CustomDataSegment custom_data_segment;
};
