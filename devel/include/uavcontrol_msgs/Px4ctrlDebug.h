// Generated by gencpp from file uavcontrol_msgs/Px4ctrlDebug.msg
// DO NOT EDIT!


#ifndef UAVCONTROL_MSGS_MESSAGE_PX4CTRLDEBUG_H
#define UAVCONTROL_MSGS_MESSAGE_PX4CTRLDEBUG_H
...
struct Px4ctrlDebug_
{
  ...
  typedef boost::shared_ptr< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> const> ConstPtr;

}; // struct Px4ctrlDebug_

typedef ::uavcontrol_msgs::Px4ctrlDebug_<std::allocator<void> > Px4ctrlDebug;

typedef boost::shared_ptr< ::uavcontrol_msgs::Px4ctrlDebug > Px4ctrlDebugPtr;
typedef boost::shared_ptr< ::uavcontrol_msgs::Px4ctrlDebug const> Px4ctrlDebugConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator1> & lhs, const ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> >
{
  ...
  static const char* value(const ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9ddf78a965614929ULL;
  static const uint64_t static_value2 = 0xf792cafb89e47f73ULL;
};

template<class ContainerAllocator>
struct DataType< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::uavcontrol_msgs::Px4ctrlDebug_<ContainerAllocator>& v)
  {
...
#endif // UAVCONTROL_MSGS_MESSAGE_PX4CTRLDEBUG_H
