// Generated by gencpp from file uavcontrol_msgs/PositionCommand.msg
// DO NOT EDIT!


#ifndef UAVCONTROL_MSGS_MESSAGE_POSITIONCOMMAND_H
#define UAVCONTROL_MSGS_MESSAGE_POSITIONCOMMAND_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> const> ConstPtr;

}; // struct PositionCommand_

typedef ::uavcontrol_msgs::PositionCommand_<std::allocator<void> > PositionCommand;

typedef boost::shared_ptr< ::uavcontrol_msgs::PositionCommand > PositionCommandPtr;
typedef boost::shared_ptr< ::uavcontrol_msgs::PositionCommand const> PositionCommandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::uavcontrol_msgs::PositionCommand_<ContainerAllocator1> & lhs, const ::uavcontrol_msgs::PositionCommand_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::uavcontrol_msgs::PositionCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2809eb0c779bbce5ULL;
  static const uint64_t static_value2 = 0xb8d66b95a05bd27bULL;
};

template<class ContainerAllocator>
struct DataType< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::uavcontrol_msgs::PositionCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::uavcontrol_msgs::PositionCommand_<ContainerAllocator>& v)
  {
...
#endif // UAVCONTROL_MSGS_MESSAGE_POSITIONCOMMAND_H
