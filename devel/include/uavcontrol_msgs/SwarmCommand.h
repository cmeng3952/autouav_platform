// Generated by gencpp from file uavcontrol_msgs/SwarmCommand.msg
// DO NOT EDIT!


#ifndef UAVCONTROL_MSGS_MESSAGE_SWARMCOMMAND_H
#define UAVCONTROL_MSGS_MESSAGE_SWARMCOMMAND_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> const> ConstPtr;

}; // struct SwarmCommand_

typedef ::uavcontrol_msgs::SwarmCommand_<std::allocator<void> > SwarmCommand;

typedef boost::shared_ptr< ::uavcontrol_msgs::SwarmCommand > SwarmCommandPtr;
typedef boost::shared_ptr< ::uavcontrol_msgs::SwarmCommand const> SwarmCommandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator1> & lhs, const ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x280b61bf48e98d61ULL;
  static const uint64_t static_value2 = 0x7871f1d573cf0c08ULL;
};

template<class ContainerAllocator>
struct DataType< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::uavcontrol_msgs::SwarmCommand_<ContainerAllocator>& v)
  {
...
#endif // UAVCONTROL_MSGS_MESSAGE_SWARMCOMMAND_H
