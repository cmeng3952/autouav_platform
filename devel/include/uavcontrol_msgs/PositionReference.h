// Generated by gencpp from file uavcontrol_msgs/PositionReference.msg
// DO NOT EDIT!


#ifndef UAVCONTROL_MSGS_MESSAGE_POSITIONREFERENCE_H
#define UAVCONTROL_MSGS_MESSAGE_POSITIONREFERENCE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> const> ConstPtr;

}; // struct PositionReference_

typedef ::uavcontrol_msgs::PositionReference_<std::allocator<void> > PositionReference;

typedef boost::shared_ptr< ::uavcontrol_msgs::PositionReference > PositionReferencePtr;
typedef boost::shared_ptr< ::uavcontrol_msgs::PositionReference const> PositionReferenceConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::uavcontrol_msgs::PositionReference_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::uavcontrol_msgs::PositionReference_<ContainerAllocator1> & lhs, const ::uavcontrol_msgs::PositionReference_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> >
{
  ...
  static const char* value(const ::uavcontrol_msgs::PositionReference_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5aa100275600b3aaULL;
  static const uint64_t static_value2 = 0x2239f15be9b50ba5ULL;
};

template<class ContainerAllocator>
struct DataType< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::uavcontrol_msgs::PositionReference_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::uavcontrol_msgs::PositionReference_<ContainerAllocator>& v)
  {
...
#endif // UAVCONTROL_MSGS_MESSAGE_POSITIONREFERENCE_H
