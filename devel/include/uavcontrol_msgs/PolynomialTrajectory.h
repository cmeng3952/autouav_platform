// Generated by gencpp from file uavcontrol_msgs/PolynomialTrajectory.msg
// DO NOT EDIT!


#ifndef UAVCONTROL_MSGS_MESSAGE_POLYNOMIALTRAJECTORY_H
#define UAVCONTROL_MSGS_MESSAGE_POLYNOMIALTRAJECTORY_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> const> ConstPtr;

}; // struct PolynomialTrajectory_

typedef ::uavcontrol_msgs::PolynomialTrajectory_<std::allocator<void> > PolynomialTrajectory;

typedef boost::shared_ptr< ::uavcontrol_msgs::PolynomialTrajectory > PolynomialTrajectoryPtr;
typedef boost::shared_ptr< ::uavcontrol_msgs::PolynomialTrajectory const> PolynomialTrajectoryConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator1> & lhs, const ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> >
{
  ...
  static const char* value(const ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3abb6e1147f95babULL;
  static const uint64_t static_value2 = 0xc52b64612c5ba5edULL;
};

template<class ContainerAllocator>
struct DataType< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::uavcontrol_msgs::PolynomialTrajectory_<ContainerAllocator>& v)
  {
...
#endif // UAVCONTROL_MSGS_MESSAGE_POLYNOMIALTRAJECTORY_H
