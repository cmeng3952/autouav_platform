...
"""autogenerated by genpy from uavcontrol_msgs/MultiUGVState.msg. Do not edit."""
import codecs
import sys
...
class MultiUGVState(genpy.Message):
  ...
  _type = "uavcontrol_msgs/MultiUGVState"
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','uavcontrol_msgs/UGVState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = uavcontrol_msgs.msg.UGVState()
        _v4 = val1.header
        start = end
        end += 4
