...
"""autogenerated by genpy from uavcontrol_msgs/MultiArucoInfo.msg. Do not edit."""
import codecs
import sys
...
class MultiArucoInfo(genpy.Message):
  ...
  _type = "uavcontrol_msgs/MultiArucoInfo"
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','uavcontrol_msgs/ArucoInfo[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = uavcontrol_msgs.msg.ArucoInfo()
        _v3 = val1.header
        start = end
        end += 4
