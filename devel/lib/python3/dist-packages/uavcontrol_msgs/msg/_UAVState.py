...
"""autogenerated by genpy from uavcontrol_msgs/UAVState.msg. Do not edit."""
import codecs
import sys
...
class UAVState(genpy.Message):
  _md5sum = "14fa9d3d6abb647e889d626f088b2192"
  _type = "uavcontrol_msgs/UAVState"
...
"""
  ...
  __slots__ = ['header','uav_id','connected','armed','mode','location_source','odom_valid','gps_status','gps_num','position','range','latitude','longitude','altitude','rel_alt','velocity','attitude','attitude_rpy','attitude_q','attitude_rate','battery_state','battery_percetage','landed']
  _slot_types = ['std_msgs/Header','uint8','bool','bool','string','uint8','bool','uint8','uint8','float32[3]','float32','float32','float32','float32','float32','float32[3]','float32[3]','float32[3]','geometry_msgs/Quaternion','float32[3]','float32','float32','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,uav_id,connected,armed,mode,location_source,odom_valid,gps_status,gps_num,position,range,latitude,longitude,altitude,rel_alt,velocity,attitude,attitude_rpy,attitude_q,attitude_rate,battery_state,battery_percetage,landed
    ...
    if args or kwds:
      ...
      if self.attitude is None:
        self.attitude = [0.] * 3
      if self.attitude_rpy is None:
        self.attitude_rpy = [0.] * 3
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_3f().pack(*self.attitude_rpy))
      _x = self
      ...
      _x = self
      buff.write(_get_struct_2fB().pack(_x.battery_state, _x.battery_percetage, _x.landed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.attitude_rpy = _get_struct_3f().unpack(str[start:end])
      _x = self
      start = end
      end += 32
      ...
      (_x.battery_state, _x.battery_percetage, _x.landed,) = _get_struct_2fB().unpack(str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(self.attitude_rpy.tostring())
      _x = self
      buff.write(_get_struct_4d().pack(_x.attitude_q.x, _x.attitude_q.y, _x.attitude_q.z, _x.attitude_q.w))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.attitude_rpy = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      _x = self
      start = end
      end += 32
      (_x.attitude_q.x, _x.attitude_q.y, _x.attitude_q.z, _x.attitude_q.w,) = _get_struct_4d().unpack(str[start:end])
