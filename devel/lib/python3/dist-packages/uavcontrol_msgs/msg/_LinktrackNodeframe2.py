...
"""autogenerated by genpy from uavcontrol_msgs/LinktrackNodeframe2.msg. Do not edit."""
import codecs
import sys
...
class LinktrackNodeframe2(genpy.Message):
  ...
  _type = "uavcontrol_msgs/LinktrackNodeframe2"
...
float32 rx_rssi"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','float32[3]','float32[3]','float32[3]','float32[3]','float32[4]','float32[3]','float32[3]','uavcontrol_msgs/LinktrackNode2[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = uavcontrol_msgs.msg.LinktrackNode2()
        _x = val1
        start = end
        end += 14
