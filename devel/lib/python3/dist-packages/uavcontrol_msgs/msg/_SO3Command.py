...
"""autogenerated by genpy from uavcontrol_msgs/SO3Command.msg. Do not edit."""
import codecs
import sys
...
class SO3Command(genpy.Message):
  ...
  _type = "uavcontrol_msgs/SO3Command"
...
"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Quaternion','float64[3]','float64[3]','uavcontrol_msgs/AuxCommand']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.kOm is None:
        self.kOm = [0.] * 3
      if self.aux is None:
        self.aux = uavcontrol_msgs.msg.AuxCommand()
    else:
      self.header = std_msgs.msg.Header()
      self.force = geometry_msgs.msg.Vector3()
      self.orientation = geometry_msgs.msg.Quaternion()
