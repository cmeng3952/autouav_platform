...
"""autogenerated by genpy from uavcontrol_msgs/LivoxCustomMsg.msg. Do not edit."""
import codecs
import sys
...
class LivoxCustomMsg(genpy.Message):
  ...
  _type = "uavcontrol_msgs/LivoxCustomMsg"
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint64','uint32','uint8','uint8[3]','uavcontrol_msgs/LivoxCustomPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = uavcontrol_msgs.msg.LivoxCustomPoint()
        _x = val1
        start = end
        end += 19
