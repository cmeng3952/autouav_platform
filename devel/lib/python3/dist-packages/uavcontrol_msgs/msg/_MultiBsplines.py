...
"""autogenerated by genpy from uavcontrol_msgs/MultiBsplines.msg. Do not edit."""
import codecs
import sys
...
class MultiBsplines(genpy.Message):
  ...
  _type = "uavcontrol_msgs/MultiBsplines"
...
"""
  ...
  _slot_types = ['int32','uavcontrol_msgs/Bspline[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = uavcontrol_msgs.msg.Bspline()
        _x = val1
        start = end
        end += 16
