...
"""autogenerated by genpy from uavcontrol_msgs/MultiDetectionInfo.msg. Do not edit."""
import codecs
import sys
...
class MultiDetectionInfo(genpy.Message):
  ...
  _type = "uavcontrol_msgs/MultiDetectionInfo"
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','int32','uavcontrol_msgs/DetectionInfo[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = uavcontrol_msgs.msg.DetectionInfo()
        _v3 = val1.header
        start = end
        end += 4
