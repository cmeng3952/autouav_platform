...
"""autogenerated by genpy from livox_ros_driver2/LivoxCustomMsg.msg. Do not edit."""
import codecs
import sys
...
class LivoxCustomMsg(genpy.Message):
  ...
  _type = "livox_ros_driver2/LivoxCustomMsg"
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint64','uint32','uint8','uint8[3]','livox_ros_driver2/LivoxCustomPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = livox_ros_driver2.msg.LivoxCustomPoint()
        _x = val1
        start = end
        end += 19
