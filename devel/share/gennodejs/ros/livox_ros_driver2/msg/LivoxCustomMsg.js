...
class LivoxCustomMsg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.points.forEach((val) => {
      bufferOffset = LivoxCustomPoint.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.points[i] = LivoxCustomPoint.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static datatype() {
    ...
    return 'livox_ros_driver2/LivoxCustomMsg';
  }
  ...
  static messageDefinition() {
    ...
    ================================================================================
    MSG: livox_ros_driver2/LivoxCustomPoint
  ...
  static Resolve(msg) {
    ...
    if (msg.points !== undefined) {
      ...
      for (let i = 0; i < resolved.points.length; ++i) {
        resolved.points[i] = LivoxCustomPoint.Resolve(msg.points[i]);
      }
    }
    else {
      resolved.points = []
