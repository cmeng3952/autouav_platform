...
class LivoxCustomPoint {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LivoxCustomPoint(null);
  ...
  static datatype() {
    ...
    return 'livox_ros_driver2/LivoxCustomPoint';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LivoxCustomPoint(null);
...
module.exports = LivoxCustomPoint;
