...
(cl:defclass <CheckForObjectsResult> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (bounding_boxes
    ...
    :type uavcontrol_msgs-msg:BoundingBoxes
    :initform (cl:make-instance 'uavcontrol_msgs-msg:BoundingBoxes)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CheckForObjectsResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckForObjectsResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uavcontrol_msgs-msg:<CheckForObjectsResult> is deprecated: use uavcontrol_msgs-msg:CheckForObjectsResult instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CheckForObjectsResult>)))
  ...
  "uavcontrol_msgs/CheckForObjectsResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckForObjectsResult)))
  "Returns string type for a message object of type 'CheckForObjectsResult"
  "uavcontrol_msgs/CheckForObjectsResult")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CheckForObjectsResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Result definition~%int16 id~%uavcontrol_msgs/BoundingBoxes bounding_boxes~%~%~%================================================================================~%MSG: uavcontrol_msgs/BoundingBoxes~%Header header~%Header image_header~%BoundingBox[] bounding_boxes~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: uavcontrol_msgs/BoundingBox~%# 目标框相关信息~%string Class # 类别~%float64 probability # 置信度~%int64 xmin # 右上角~%int64 ymin~%int64 xmax # 坐下角~%int64 ymax~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CheckForObjectsResult)))
  "Returns full string definition for message of type 'CheckForObjectsResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Result definition~%int16 id~%uavcontrol_msgs/BoundingBoxes bounding_boxes~%~%~%================================================================================~%MSG: uavcontrol_msgs/BoundingBoxes~%Header header~%Header image_header~%BoundingBox[] bounding_boxes~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: uavcontrol_msgs/BoundingBox~%# 目标框相关信息~%string Class # 类别~%float64 probability # 置信度~%int64 xmin # 右上角~%int64 ymin~%int64 xmax # 坐下角~%int64 ymax~%~%~%~%"))
