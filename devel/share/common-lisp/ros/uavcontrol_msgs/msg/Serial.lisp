...
(cl:defmethod cl:initialize-instance :after ((m <Serial>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Serial)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uavcontrol_msgs-msg:<Serial> is deprecated: use uavcontrol_msgs-msg:Serial instead.")))
...
(cl:defmethod channel-val ((m <Serial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:channel-val is deprecated.  Use uavcontrol_msgs-msg:channel instead.")
  (channel m))
...
(cl:defmethod data-val ((m <Serial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:data-val is deprecated.  Use uavcontrol_msgs-msg:data instead.")
  (data m))
