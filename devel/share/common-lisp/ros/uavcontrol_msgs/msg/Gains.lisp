...
(cl:defmethod cl:initialize-instance :after ((m <Gains>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gains)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uavcontrol_msgs-msg:<Gains> is deprecated: use uavcontrol_msgs-msg:Gains instead.")))
...
(cl:defmethod Kp_yaw-val ((m <Gains>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:Kp_yaw-val is deprecated.  Use uavcontrol_msgs-msg:Kp_yaw instead.")
  (Kp_yaw m))

(cl:ensure-generic-function 'Kd_yaw-val :lambda-list '(m))
(cl:defmethod Kd_yaw-val ((m <Gains>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:Kd_yaw-val is deprecated.  Use uavcontrol_msgs-msg:Kd_yaw instead.")
  (Kd_yaw m))
