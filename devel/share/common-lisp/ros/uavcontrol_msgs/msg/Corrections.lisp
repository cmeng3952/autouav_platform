...
(cl:defmethod cl:initialize-instance :after ((m <Corrections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Corrections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uavcontrol_msgs-msg:<Corrections> is deprecated: use uavcontrol_msgs-msg:Corrections instead.")))
