...
(cl:defmethod cl:initialize-instance :after ((m <Odometry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Odometry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uavcontrol_msgs-msg:<Odometry> is deprecated: use uavcontrol_msgs-msg:Odometry instead.")))

(cl:ensure-generic-function 'curodom-val :lambda-list '(m))
(cl:defmethod curodom-val ((m <Odometry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:curodom-val is deprecated.  Use uavcontrol_msgs-msg:curodom instead.")
  (curodom m))

(cl:ensure-generic-function 'kfodom-val :lambda-list '(m))
(cl:defmethod kfodom-val ((m <Odometry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:kfodom-val is deprecated.  Use uavcontrol_msgs-msg:kfodom instead.")
  (kfodom m))

(cl:ensure-generic-function 'kfid-val :lambda-list '(m))
(cl:defmethod kfid-val ((m <Odometry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:kfid-val is deprecated.  Use uavcontrol_msgs-msg:kfid instead.")
  (kfid m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <Odometry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:status-val is deprecated.  Use uavcontrol_msgs-msg:status instead.")
  (status m))
