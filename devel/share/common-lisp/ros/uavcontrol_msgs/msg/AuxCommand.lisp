...
(cl:defmethod cl:initialize-instance :after ((m <AuxCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AuxCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uavcontrol_msgs-msg:<AuxCommand> is deprecated: use uavcontrol_msgs-msg:AuxCommand instead.")))

(cl:ensure-generic-function 'current_yaw-val :lambda-list '(m))
(cl:defmethod current_yaw-val ((m <AuxCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:current_yaw-val is deprecated.  Use uavcontrol_msgs-msg:current_yaw instead.")
  (current_yaw m))

(cl:ensure-generic-function 'kf_correction-val :lambda-list '(m))
(cl:defmethod kf_correction-val ((m <AuxCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:kf_correction-val is deprecated.  Use uavcontrol_msgs-msg:kf_correction instead.")
  (kf_correction m))

(cl:ensure-generic-function 'angle_corrections-val :lambda-list '(m))
(cl:defmethod angle_corrections-val ((m <AuxCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:angle_corrections-val is deprecated.  Use uavcontrol_msgs-msg:angle_corrections instead.")
  (angle_corrections m))

(cl:ensure-generic-function 'enable_motors-val :lambda-list '(m))
(cl:defmethod enable_motors-val ((m <AuxCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:enable_motors-val is deprecated.  Use uavcontrol_msgs-msg:enable_motors instead.")
  (enable_motors m))

(cl:ensure-generic-function 'use_external_yaw-val :lambda-list '(m))
(cl:defmethod use_external_yaw-val ((m <AuxCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uavcontrol_msgs-msg:use_external_yaw-val is deprecated.  Use uavcontrol_msgs-msg:use_external_yaw instead.")
  (use_external_yaw m))
