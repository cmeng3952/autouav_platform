...
#include "uavcontrol_msgs/MultiUAVState.h"
#include "uavcontrol_msgs/SwarmCommand.h"
#include "uavcontrol_msgs/UAVState.h"
#include "uavcontrol_msgs/OffsetPose.h"
#include "uavcontrol_msgs/MultiUGVState.h"
...
public:
    ...
    void swarmCmdCb(const uavcontrol_msgs::SwarmCommand::ConstPtr &msg);
    ...
    inline uavcontrol_msgs::UAVState getUAVStateMsg(){return this->uav_state_msg_;};
...
private:
    ...
    uavcontrol_msgs::UAVState uav_state_msg_;
